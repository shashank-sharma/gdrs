    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cab', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='worker.Cab')),
            ],
        ),
        migrations.CreateModel(
            name='Driver',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('driver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='worker.Driver')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='cab',
            name='driver',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='worker.Driver'),
        ),
        migrations.AddField(
            model_name='cab',
            name='user',
